...
const { EnvVar } = require('agents');
const { logger } = require('data-schemas');
const { sanitizeFilename, parseText, processAudioFile } = require('api');
const {
  convertImage,
  resizeAndConvert,
  resizeImageBuffer,
 ...
 * @param {RunClient} params.client - The AgentChat client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.
