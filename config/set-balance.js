...
const { getBalanceConfig } = require('api');
const { User, Balance } = require('data-schemas').createModels(mongoose);
...
(async () => {
  ...
  if (!balanceConfig?.enabled) {
    console.red('Error: Balance is not enabled. Use agentchat.yaml to enable it');
    silentExit(1);
  }
