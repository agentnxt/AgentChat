...
/**
 * AgentChat Cache Flush Utility
 *
 * This script flushes the cache store used by AgentChat, whether it's
...
DESCRIPTION:
  Flushes the cache store used by AgentChat. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the AgentChat backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 AgentChat Cache Flush Utility');
  console.log('================================');
