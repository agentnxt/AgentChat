# Dynamic Theme System for @agentchat/client
...
```bash
npm install @agentchat/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@agentchat/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@agentchat/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@agentchat/client';
...
```tsx
import { useTheme } from '@agentchat/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@agentchat/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@agentchat/client';
...
This theme system is part of the @agentchat/client package. 