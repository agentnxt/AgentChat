...
import type { JsonSchemaType } from 'data-schemas';
...
export class MCPServerInspector {
  ...
  /**
   * Converts server tools to AgentChat-compatible tool functions format.
   * @param serverName - The name of the server
   * @param connection - The MCP connection
   * @returns Tool functions formatted for AgentChat
   */
