import { extractAgentChatParams } from './llm';

describe('extractAgentChatParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractAgentChatParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractAgentChatParams();
  ...
  it('should extract all AgentChat params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractAgentChatParams(options);
  ...
  it('should handle null values for AgentChat params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known AgentChat params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractAgentChatParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional AgentChat params', () => {
    const options = {
      resendFiles: false,
