import { EModelEndpoint, agentsEndpointSchema } from 'agentchat-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'agentchat-data-provider';

/**
 * Sets up the Agents configuration from the config (`agentchat.yaml`) file.
