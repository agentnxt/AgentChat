...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should throw an error if environment variables are set but not configured', () => {
    const validConfigs: TAzureGroups = [
      {
        group: 'agentchat-westus',
        apiKey: '${WESTUS_API_KEY}',
        instanceName: 'agentchat-westus',
      ...
      {
        group: 'agentchat-eastus',
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'agentchat-eastus',
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'agentchat-westus'
    expect(groupMap).toHaveProperty('agentchat-westus');
    expect(groupMap['agentchat-westus']).toEqual(
    ...
    // Check groupMap for 'agentchat-eastus'
    expect(groupMap).toHaveProperty('agentchat-eastus');
    expect(groupMap['agentchat-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'agentchat-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'agentchat-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'agentchat-eastus',
