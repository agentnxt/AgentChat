...
AgentChat is a monorepo with the following key workspaces:

| Workspace | Language | Side | Dependency | Purpose |
|---|---|---|---|---|
| `/api` | JS (legacy) | Backend | `packages/api`, `packages/data-schemas`, `packages/data-provider`, `@agentchat/agents` | Express server — minimize changes here |
...
The source code for `@agentchat/agents` (major backend dependency, same team) is at `/home/danny/agentus`.
