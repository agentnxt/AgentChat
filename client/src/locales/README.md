# AgentChat Localization Guide

This guide explains how to add new languages to AgentChat's localization system.

## Adding a New Language

To add a new language to AgentChat, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [AgentChat locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through AgentChat's automated translation platform
