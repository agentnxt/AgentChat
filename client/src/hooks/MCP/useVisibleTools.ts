...
import type { TPlugin } from 'agentchat-data-provider';
 ...
 * Separates regular AgentChat tools from MCP servers.
 *
 * @param selectedToolIds - Array of selected tool IDs
 * @param regularTools - Array of regular AgentChat tools
