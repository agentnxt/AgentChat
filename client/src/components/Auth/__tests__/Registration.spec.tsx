...
import * as mockDataProvider from 'agentchat-data-provider/react-query';
import type { TStartupConfig } from 'agentchat-data-provider';
...
jest.mock('agentchat-data-provider/react-query');
